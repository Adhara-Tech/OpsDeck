...
Usage:
    python google-sync.py provision --dry-run    # Preview new Google users
    python google-sync.py provision --execute    # Create users in Google
    python google-sync.py suspend --dry-run      # Preview suspensions
    python google-sync.py suspend --execute      # Suspend users in Google
    python google-sync.py all --dry-run          # Preview both
    python google-sync.py all --execute          # Run both
